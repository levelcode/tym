...
tymApp.controller( 'ProductListCtrl', ['$scope' ,'$log' ,'$rootScope' ,'$cookies' ,'ConstantsService', 'UtilService', '$timeout', '$document', function( $scope ,$log ,$rootScope ,$cookies, ConstantsService, UtilService, $timeout, $document ){
