...
function login( $id = "", $pass = "", $json = false, $debug = false, $email = false, $user_type ){
    $con = conectar();
    ...
    if($id == "" || $pass == ""){
        ...
        if( $user_type ){
            ...
            $user_colum = "user_name";
            $status_column = 'tym_user_status_id';
        }

        $sql = "SELECT " . $table_name .".*".
        " FROM ".$table_name.
        " WHERE ". $table_name. "." .$user_colum." = :id AND ".$status_column ." = 1";
