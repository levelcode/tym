...
class TCPDF {
	...
	public function Header() {
		if ($this->header_xobjid === false) {
			...
			$this->SetX($header_x);
			$this->MultiCell($cw, $cell_height, $headerdata['string'], 0, '', 0, 1, '', '', true, 0, false, true, 0, 'M', false);
	...
	public function Footer() {
		...
		if (empty($this->pagegroups)) {
			...
			$pagenumtxt = 'Página '.$w_page.$this->getPageNumGroupAlias().' de '.$this->getPageGroupAlias();
		}
		$this->SetY($cur_y);
		//Print page number
		if ($this->getRTL()) {
