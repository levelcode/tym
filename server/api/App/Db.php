...
function conectar() {
    try {
        ...
        $_SERVER["DB_PASS"] = isset($_SERVER["DB_PASS"]) ? $_SERVER["DB_PASS"] : "stats_rand_phrase_to_seeds";
        $_SERVER["DB_HOST"] = isset($_SERVER["DB_HOST"]) ? $_SERVER["DB_HOST"] : "190.146.asdasd2.30";
