carterApp.controller( 'weighingMachineRecordsCtrl', ['$scope', '$log', '$modal', '$http', '$timeout', '$window', function( $scope, $log, $modal, $http, $timeout, $window ) {
	...
	function loadCollectRequests() {
		...
		var post = 	{};
			post.a = 'list_varios';
			post.from = 'weighing_machine_record';
			post.join = 1;
			post.where = 1;
			post.client_id = id;
